...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.ChannelRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.Media", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.ChannelMember", b =>
                {
                    ...
                    b.HasOne("CommunicationsApp.Domain.Entities.ChannelRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CommunicationsApp.Domain.Entities.Media", b =>
                {
                    b.HasOne("CommunicationsApp.Domain.Common.Enums.MediaType", null)
                        .WithMany()
                        .HasForeignKey("MediaTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CommunicationsApp.Domain.Entities.Message", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("CommunicationsApp.Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
